...
@Set WORKDRIVE=C
@Set JDK=%WORKDRIVE%:"\Users\Bruno\.jdks\azul-15.0.4"
...
@set JAVAPROJ=%WORKDRIVE%:\\Users\\%USERNAME%\\Documents\\Projects\\%JAVAPROJ_NAME%
...
@Set PRODUCER_CLASS_PREFIX=JobGroup
